...
| `config/AGENTS.core.md` | `~/.pi/agent/AGENTS.core.md` | The ~4.4 KB distilled core (`core-rules` re-injects it into the context mid-session). The extension **does nothing, silently**, when this file is missing. |
